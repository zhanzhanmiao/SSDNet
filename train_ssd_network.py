...
def main():
    ...
    with tf.Graph().as_default():
        ...
        deploy_config = model_deploy.DeploymentConfig(
            num_clones = 1,#=FLAGS.num_clones,
            clone_on_cpu=1,#FLAGS.clone_on_cpu,
            replica_id=0,
            num_replicas=1,
            num_ps_tasks=0)
        # Create global_step.
        ...
        train_dir = 'E:/DeepLearning/SSD-Tensorflow-master/logs/'
        # tf_utils.print_configuration(FLAGS.__flags, ssd_params,
        #                              dataset.data_sources, train_dir)
        # =================================================================== #
        ...
        # Variables to train.
        variables_to_train = tf_utils.get_variables_to_train(Config)
